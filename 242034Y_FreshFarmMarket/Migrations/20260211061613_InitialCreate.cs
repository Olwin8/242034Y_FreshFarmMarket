        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditCardNoEncrypted = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    LastFailedLoginAttempt = table.Column<DateTime>(type: "datetime", nullable: true),
                    TwoFactorEnabled = table.Column<bool>(type: "bit", nullable: false),
                    TwoFactorMethod = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CurrentSessionId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    LastSessionActivity = table.Column<DateTime>(type: "datetime", nullable: true),
                    LastPasswordResetRequest = table.Column<DateTime>(type: "datetime", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastActivity = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "GETDATE()"),
                    ExpiresAt = table.Column<DateTime>(type: "datetime", nullable: false),
                    TerminatedAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    TerminationReason = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsMainDevice = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_FailedLoginAttempts",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_LastPasswordChangeDate",
                table: "AspNetUsers",
